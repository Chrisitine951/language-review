...
// ============================================================
// 18 週備考大表（v2.1.0 建立；v2.2.7 依實際進度整個重排）
// 起算 2026-07-20（週一）→ 考試 2026-11-21（週六）＝ 共 18 週，目標總分 7.0
//
// 【v2.2.7 為什麼整個重排】原版假設「邊做題邊學方法」，W1 就開始做劍10 T1。
//   但 Christine 實際選擇「先把《平行閱讀法》整本讀完再開始做題」，W2–3 純讀書，
//   W4 才開始常規練習——於是原版 W4 之後每一週的材料編號全部對不上，
//   而且新增的每週習慣（範文背誦、每日日記）原版一格都沒有。只改前兩週會留下錯位，
//   所以整份重排。做題週數從原本 17 週縮成 14 週（W4–W17），材料因此要取捨：
//   **砍掉劍14、劍15，模考從 5 次減為 4 次**（已與 Christine 確認）。
//
...
//   - ⚠️ **聽力完整一回排在週六**：她的聽力六步驟檢討流程實測約 2.5–3 小時，
//     平日晚上塞不下（會吃滿整晚還做不完，中斷後隔天狀態會斷掉）。
//     步驟③⑥都要「趁記憶還熱時再聽」，拆兩天會削弱設計用意，所以整回放週六。
//   - 週日留給每週回顧＋EGIU 本週複習（輕量）
//
// 【五階段】W1–3 方法建立（讀完平行閱讀法，不做題）→ W4–7 應用方法（不限時）→
//           W8–11 提量＋限時 → W12–15 全限時＋模考 → W16–17 衝刺 → W18 考前週
//
// 【材料分配】劍10（W3–W7）→ 劍11（W7–W10）→ 劍12（W11–W13）→ 劍13（W14–W16）；
//   模考 4 次用劍18 T1/T2、劍19 T1/T2。劍14、劍15、劍20 這次不排。
//
// 【每週固定習慣】（不逐日列進計畫格，避免灌爆畫面）
//   - 每天：英文日記 3 句（記錄頁日記分頁有每日題目，從文法/口說/閱讀隨機出）
//   - 每天：EGIU 1 單元（文法頁棋盤打卡）
...
const IELTS_STUDY_PLAN = [
  ...
  { week: '2026-07-20', no: 1, phase: '第一階段・方法建立（W1–3）', egiu: 'Unit 1–9', items: [
    ...
    ['writing', 6, '每週回顧'],
    ['material', 6, 'EGIU Unit 1–9（每日1單元，週末複習本週）'],
  ]},
  ...
  { week: '2026-08-03', no: 3, phase: '第一階段・方法建立（W1–3）', egiu: 'Unit 19–27', items: [
    ...
    ['listening', 5, '【暖身】劍10 T1 聽力完整一回＋六步驟檢討（約2.5–3小時）'],
    ['writing', 6, '每週回顧（讀完了！下週開始做題）'],
    ['material', 6, 'EGIU Unit 19–27'],
  ]},

  // ===== 第二階段：應用方法・不限時（W4–7）——劍10 全4回 =====
  { week: '2026-08-10', no: 4, phase: '第二階段・應用方法・不限時（W4–7）', egiu: 'Unit 28–36', items: [
    ['reading', 0, '劍10 T1 P1 不限時＋拆解檢核'],
    ['reading', 1, '劍10 T1 P2 不限時＋拆解檢核'],
    ['speaking', 2, 'Cambly＋口說範例回答解析'],
    ['reading', 4, '劍10 T1 P3 不限時＋拆解檢核'],
    ['listening', 5, '劍10 T2 聽力完整一回＋六步驟檢討'],
    ['writing', 6, '寫作範文解析 1 篇＋每週回顧'],
    ['material', 6, 'EGIU Unit 28–36'],
  ]},
  { week: '2026-08-17', no: 5, phase: '第二階段・應用方法・不限時（W4–7）', egiu: 'Unit 37–45', items: [
    ['reading', 0, '劍10 T2 P1 不限時＋拆解檢核'],
    ['reading', 1, '劍10 T2 P2–P3 不限時'],
  ...
  { week: '2026-08-24', no: 6, phase: '第二階段・應用方法・不限時（W4–7）', egiu: 'Unit 46–54', items: [
    ['reading', 0, '劍10 T3 P1–P2 不限時'],
    ['reading', 1, '劍10 T3 P3＋拆解檢核'],
    ['speaking', 2, 'Cambly＋核心語料第2份'],
    ['writing', 4, '【第一篇】Task 2 不限時（plan 10分鐘要做滿）'],
    ['listening', 5, '劍10 T4 聽力完整一回＋檢討'],
    ['writing', 6, 'Task 2 訂正（訂正比多寫一篇有效）＋每週回顧'],
    ['material', 6, 'EGIU Unit 46–54'],
  ]},
  { week: '2026-08-31', no: 7, phase: '第二階段・應用方法・不限時（W4–7）', egiu: 'Unit 55–63', items: [
    ['reading', 0, '劍10 T4 P1–P2 不限時'],
    ['reading', 1, '劍10 T4 P3＋拆解檢核'],
    ['speaking', 2, 'Cambly＋自錄15分鐘'],
    ['writing', 4, 'Task 1 結構＋圖表詞彙＋範文解析 1 篇'],
    ['listening', 5, '劍11 T1 聽力完整一回＋檢討'],
    ['writing', 6, '每週回顧（劍10 做完！看拆解檢核平均分與猜題率）'],
    ['material', 6, 'EGIU Unit 55–63'],
  ]},

  // ===== 第三階段：提量＋限時（W8–11）——劍11 全4回＋劍12 起頭 =====
  { week: '2026-09-07', no: 8, phase: '第三階段・提量＋限時（W8–11）', egiu: 'Unit 64–72', items: [
    ['reading', 0, '劍11 T1 P1 計時20分鐘（開始限時）'],
    ['reading', 1, '劍11 T1 P2–P3 計時20分鐘'],
  ...
  { week: '2026-09-14', no: 9, phase: '第三階段・提量＋限時（W8–11）', egiu: 'Unit 73–81', items: [
    ['reading', 0, '劍11 T2 P1–P2 各計時20分鐘'],
    ['reading', 1, '劍11 T2 P3＋拆解檢核'],
    ['speaking', 2, 'Cambly＋自錄15分鐘×2（本週起固定）'],
    ['writing', 4, 'Task 2 一篇 60分鐘內＋範文解析 1 篇'],
    ['listening', 5, '劍11 T3 聽力完整一回＋檢討'],
    ['writing', 6, 'Task 2 訂正＋每週回顧'],
    ['material', 6, 'EGIU Unit 73–81'],
  ]},
  { week: '2026-09-21', no: 10, phase: '第三階段・提量＋限時（W8–11）', egiu: 'Unit 82–90', items: [
    ['reading', 0, '劍11 T3 閱讀整回（記錄總耗時，先不強制60分）'],
    ['reading', 1, '劍11 T3 錯題檢討＋全部過拆解檢核'],
    ['speaking', 2, 'Cambly＋核心語料第4份'],
    ['writing', 4, 'Task 1 30分鐘限時'],
    ['listening', 5, '劍11 T4 聽力完整一回＋檢討'],
    ['writing', 6, '每週回顧'],
    ['material', 6, 'EGIU Unit 82–90'],
  ]},
  { week: '2026-09-28', no: 11, phase: '第三階段・提量＋限時（W8–11）', egiu: 'Unit 91–99', items: [
    ['reading', 0, '劍12 T1 閱讀整回 60分鐘限時（首次全限時）'],
    ['reading', 1, '限時結果檢討＋錯題全部過拆解檢核'],
    ['speaking', 2, 'Cambly＋口說模考（Part 1–3 全程錄音）'],
    ['writing', 4, 'Task 2 40分鐘限時（首次）'],
    ['listening', 5, '劍12 T1 聽力整回30分＋完整檢討'],
    ['writing', 6, 'Task 2 訂正重寫＋階段回顧（列出四科弱點清單）'],
    ['material', 6, 'EGIU Unit 91–99'],
  ]},

  // ===== 第四階段：全限時＋模考（W12–15）——劍12–13，模考1、2 =====
  { week: '2026-10-05', no: 12, phase: '第四階段・全限時＋模考（W12–15）', egiu: 'Unit 100–108', items: [
    ['reading', 0, '劍12 T2 閱讀 60分鐘限時'],
    ['reading', 1, '錯題檢討＋弱題型專練'],
    ['speaking', 2, 'Cambly＋弱點題型口說練習'],
    ['writing', 4, 'Task 1 20分＋Task 2 40分（連寫60分鐘）'],
    ['listening', 5, '劍12 T2 聽力整回30分＋完整檢討'],
    ['writing', 6, '訂正＋每週回顧'],
    ['material', 6, 'EGIU Unit 100–108'],
  ]},
  { week: '2026-10-12', no: 13, phase: '第四階段・全限時＋模考（W12–15）', egiu: 'Unit 109–117', items: [
    ['reading', 0, '劍12 T3 閱讀 60分鐘限時'],
    ['listening', 1, '劍12 T3 聽力30分＋檢討'],
    ['speaking', 2, 'Cambly＋自錄×2'],
    ['writing', 4, '模板總複習（Task 1＋2 各題型開頭結尾）'],
    ['reading', 5, '【模考1】劍18 T1 聽力＋閱讀＋寫作連做（照考試時序）'],
    ['writing', 6, '模考1 完整檢討（四科弱點清單）＋成績記進練習紀錄'],
    ['material', 6, 'EGIU Unit 109–117'],
  ]},
  { week: '2026-10-19', no: 14, phase: '第四階段・全限時＋模考（W12–15）', egiu: 'Unit 118–126', items: [
    ['reading', 0, '模考1 弱點：弱題型專練'],
    ['listening', 1, '模考1 聽力錯因專練＋場景詞'],
    ['speaking', 2, 'Cambly＋弱點題型口說練習'],
    ['writing', 4, 'Task 2 弱題型一篇 40分鐘'],
    ['listening', 5, '劍13 T1 聽力完整一回＋檢討'],
    ['reading', 6, '劍13 T1 閱讀 60分鐘＋每週回顧'],
    ['material', 6, 'EGIU Unit 118–126'],
  ]},
  { week: '2026-10-26', no: 15, phase: '第四階段・全限時＋模考（W12–15）', egiu: 'Unit 127–135', items: [
    ['reading', 0, '劍13 T2 閱讀 60分鐘限時'],
    ['listening', 1, '劍13 T2 聽力30分＋檢討'],
    ['speaking', 2, 'Cambly＋口說模考第2次'],
    ['writing', 4, 'Task 1 各圖表模板總複習'],
    ['reading', 5, '【模考2】劍18 T2 全科連做'],
    ['writing', 6, '模考2 完整檢討＋每週回顧'],
    ['material', 6, 'EGIU Unit 127–135'],
  ]},

  // ===== 第五階段：衝刺（W16–17）——每週一次全模考 =====
  { week: '2026-11-02', no: 16, phase: '第五階段・衝刺（W16–17）', egiu: 'Unit 136–145', items: [
    ['reading', 0, '模考2 弱點專練'],
    ['listening', 1, '劍13 T3 聽力30分＋檢討'],
    ['speaking', 2, 'Cambly＋串題總演練（一份語料對五題）'],
    ['writing', 4, 'Task 2 高頻主題 plan 練習×3（只 plan 不寫全篇）'],
    ['reading', 5, '【模考3】劍19 T1 全科連做'],
    ['writing', 6, '模考3 完整檢討＋每週回顧'],
    ['material', 6, 'EGIU Unit 136–145（週末複習）→ 145 全部完成！'],
  ]},
  { week: '2026-11-09', no: 17, phase: '第五階段・衝刺（W16–17）', egiu: '總複習（只翻答錯過的單元）', items: [
    ['reading', 0, '模考3 弱點專練'],
    ['listening', 1, '聽力錯因總瀏覽＋場景詞掃讀'],
    ['speaking', 2, 'Cambly＋考場流程演練'],
    ['writing', 4, '模板默寫一次（Task 1＋2 各題型開頭結尾）'],
    ['reading', 5, '【模考4】劍19 T2 全科連做（最後一次全模考）'],
    ['writing', 6, '模考4 檢討＋拆解檢核紀錄總回顧（看平均分與猜題率）'],
